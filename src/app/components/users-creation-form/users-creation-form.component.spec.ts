...
describe('UsersCreationFormComponent', () => {
  ...
  it('should display success message and reset form on successful registration', async () => {
    ...
    expect(component.userCreationForm.get('firstName')?.value).toBe('');
    expect(component.userCreationForm.get('lastName')?.value).toBe('');
    expect(component.userCreationForm.get('email')?.value).toBe('');
    expect(component.userCreationForm.get('dateOfBirth')?.value).toBe('');
    expect(component.userCreationForm.get('city')?.value).toBe('');
    expect(component.userCreationForm.get('postalCode')?.value).toBe('');
